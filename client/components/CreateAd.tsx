...
interface CreateAdProps {
  onCreateCampaign: (campaign: Omit<AdCampaign, 'id' | 'createdAt' | 'impressions' | 'clicks' | 'spent'>) => Promise<string>;
  onProcessPayment: (campaignId: string, amount: number, method: PaymentMethod, phone: string) => Promise<boolean>;
}

export function CreateAd({ onCreateCampaign, onProcessPayment }: CreateAdProps) {
  ...
  const handleAddInterest = (interest: string) => {
    if (interest && !formData.targetAudience.interests.includes(interest)) {
      handleInputChange('targetAudience.interests', [...formData.targetAudience.interests, interest]);
    }
  };
      ...
      {step === 2 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>কোন ধরনের মানুষদের কাছে বিজ্ঞাপন পৌঁছাতে চান?</CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
              ...
              <div className="flex items-center space-x-4 mt-2">
                <div className="flex-1">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleInputChange('targetAudience.ageMin', parseInt(e.target.value))}
                  />
                </div>
                <div className="flex-1">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleInputChange('targetAudience.ageMax', parseInt(e.target.value))}
                  />
                </div>
              </div>
            </div>
            ...
            <div>
              <Label>লিঙ্গ</Label>
              <Select value={formData.targetAudience.gender} onValueChange={(value) => handleInputChange('targetAudience.gender', value)}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2 mt-2">
                {['টেকনোলজি', 'ফ্যাশন', 'খেলাধুলা', 'ভ্রমণ', 'খাবার', 'সিনেমা', 'সঙ্গীত', 'ব্যবসা'].map(interest => (
                  <Button
                    key={interest}
                    variant={formData.targetAudience.interests.includes(interest) ? "default" : "outline"}
                    size="sm"
                    onClick={() => {
                      if (formData.targetAudience.interests.includes(interest)) {
            ...
            <Card className="bg-blue-50">
              <CardContent className="pt-4">
                ...
                <p className="text-sm text-muted-foreground mt-2">
                  {formData.duration} দিনের জন্য • প্রতিদিন ৳{Math.round(calculateCost() / formData.duration)}
                </p>
              </CardContent>
            </Card>
            ...
            <div className="flex space-x-4">
              ...
              <Button onClick={handleCreateCampaign} disabled={isLoading} className="flex-1">
          ...
          <DialogContent>
            ...
            <div className="space-y-4">
              ...
              <Alert>
                ...
                <AlertDescription>
                  পেমেন্ট নম্বর: <strong>01650074073</strong><br />
                  এই নম্বারে {paymentData.method === 'bkash' ? 'বিকাশ' : 'নগদ'} এর মাধ্যমে 
                  ৳{calculateCost()} টাকা পাঠান এবং আপনার নম্বার নিচে দিন।
                </AlertDescription>
              </Alert>

              <div>
                <Label>আপনার {paymentData.method === 'bkash' ? 'বিকাশ' : 'নগদ'} নম্বার</Label>
                <Input
              ...
              <Button onClick={handlePayment} disabled={isLoading || !paymentData.phone} className="w-full">
      ...
      {step === 4 && (
        <Card>
          <CardContent className="pt-6 text-center">
            ...
            <h2 className="text-2xl font-bold mb-2">বিজ্ঞাপন সফলভাবে তৈরি হয়েছে!</h2>
            <p className="text-muted-foreground mb-6">
              আপনার বিজ্ঞাপন শীঘ্রই লাইভ হবে এবং টার্গেট অডিয়েন্সের কাছে পৌঁছাতে শুরু করবে।
            </p>
